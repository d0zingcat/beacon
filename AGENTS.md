...
- **README**: maintain both [README.md](./README.md) (English) and [README.zh-CN.md](./README.zh-CN.md) (Chinese); keep them in sync when updating user-facing docs.
- **Other docs**: code comments, PR titles/descriptions, and design docs in English.
